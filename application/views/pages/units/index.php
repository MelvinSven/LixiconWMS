                                    ...
                                    <tr>
                                        ...
                                        <?php if ($this->session->userdata('role') == 'admin') : ?>
                                            <td class="border-top-0 text-center text-muted px-2 py-4">
                                                ...
                                                <button class="btn btn-sm" data-toggle="modal" data-target="#deleteModal<?= $row->id ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Apakah Anda yakin ingin menghapus satuan <strong><?= ucfirst($row->nama) ?></strong>?</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                <a href="<?= base_url('units/delete/' . $row->id) ?>" class="btn btn-danger">Ya, Hapus</a>
            </div>
        </div>
    </div>
</div>
