                        ...
                        <table class="table no-wrap v-middle mb-0">
                            <thead>
                                <tr class="border-0">
                                    ...
                                    <th class="border-0 font-14 font-weight-medium text-muted text-center">Gudang</th>
                                ...
                                <?php foreach ($content as $row): ?>
                                    <tr>
                                        ...
                                        <td class="border-top-0 text-center text-muted px-2 py-4">
                                            <?= isset($row->nama_gudang) ? htmlspecialchars($row->nama_gudang) : '-' ?>
                                        </td>
                                        ...
                                        <?php if ($this->session->userdata('role') == 'admin'): ?>
                                            <td class="border-top-0 text-center text-muted px-2 py-4">
                                                ...
                                                <?php if ($row->id != $this->session->userdata('id_user')): ?>
                                                    <a href="<?= base_url("users/delete/$row->id") ?>" class="btn btn-sm btn-delete" onclick="return confirm('Apakah Anda yakin ingin menghapus user ini?')">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12 mb-2">
                                <a href="<?= base_url('users') ?>" class="btn btn-primary btn-rounded text-white"><i
                                        class="fas fa-angle-left"></i> Daftar Karyawan</a>
                            </div>
