...
<head>
    ...
    <style>
        ...
        /* Ensure page-wrapper is visible even if JS fails */
        .page-wrapper {
...
<body>
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <?php
            // Explicitly clear flash messages after displaying them once,
            // to prevent them from persisting on refresh (ngrok workaround)
    ...
    <script>
        $(document).ready(function () {
            // Force hide preloader after 2 seconds as fallback
            setTimeout(function () {
                $(".preloader").fadeOut();
            }, 2000);

            // Auto-dismiss flash message alerts after 3 seconds
            setTimeout(function () {
    ...
    <script src='https://cdn.jotfor.ms/agent/embedjs/019c942c3f2677d78d4580ae5ba3c850321e/embed.js'>
    </script>
    <!-- Alert Flash Message -->
